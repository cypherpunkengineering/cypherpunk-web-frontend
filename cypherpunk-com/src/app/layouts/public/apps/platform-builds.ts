export class PlatformBuilds {
  static mac = {
    ...
    appLink: '/apps/macos',
    versions: '',
    link: 'https://download.cypherpunk.com/release/macos/cypherpunk-privacy-macos-0.8.2-beta-01430.zip'
  };
  ...
  static windows = {
    ...
    link: 'https://download.cypherpunk.com/release/windows/cypherpunk-privacy-windows-0.8.2-beta-01430.exe'
  };
    ...
    */
    {
      ...
      os: 'Debian/Ubuntu/Mint',
      version: '64-bit',
      link: 'https://download.cypherpunk.com/release/debian/cypherpunk-privacy-linux-0.8.2-beta-01430.deb'
    }
  ];
