...
const routes = [
  ...
  { url: baseRoute + 'download/windows/autostart', dirPath: baseDir + 'download/windows/autostart.html' },
  { url: baseRoute + 'download/mac/autostart', dirPath: baseDir + 'download/mac/autostart.html' },
  { url: baseRoute + 'download/macos/autostart', dirPath: baseDir + 'download/macos/autostart.html' },
  { url: baseRoute + 'download/linux/autostart', dirPath: baseDir + 'download/linux/autostart.html' },
  { url: baseRoute + 'download/android/autostart', dirPath: baseDir + 'download/android/autostart.html' },
  { url: baseRoute + 'download/ios/autostart', dirPath: baseDir + 'download/ios/autostart.html' },
