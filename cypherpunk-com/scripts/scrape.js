...
const routes = [
  ...
  { url: baseRoute + 'download/autostart', dirPath: baseDir + 'download.html' },
  ...
  { url: baseRoute + 'apps/autostart', dirPath: baseDir + 'apps.html' },
  { url: baseRoute + 'apps/browser', dirPath: baseDir + 'apps/browser.html' },
  { url: baseRoute + 'apps/mac', dirPath: baseDir + 'apps/mac.html' },
  { url: baseRoute + 'apps/mac/autostart', dirPath: baseDir + 'apps/mac.html' },
  { url: baseRoute + 'apps/macos', dirPath: baseDir + 'apps/macos.html' },
  { url: baseRoute + 'apps/macos/autostart', dirPath: baseDir + 'apps/macos.html' },
  { url: baseRoute + 'apps/windows', dirPath: baseDir + 'apps/windows.html' },
  { url: baseRoute + 'apps/windows/autostart', dirPath: baseDir + 'apps/windows.html' },
  { url: baseRoute + 'apps/ios', dirPath: baseDir + 'apps/ios.html' },
  { url: baseRoute + 'apps/ios/autostart', dirPath: baseDir + 'apps/ios.html' },
  { url: baseRoute + 'apps/android', dirPath: baseDir + 'apps/android.html' },
  { url: baseRoute + 'apps/android/autostart', dirPath: baseDir + 'apps/android.html' },
  { url: baseRoute + 'apps/linux', dirPath: baseDir + 'apps/linux.html' },
  { url: baseRoute + 'apps/linux/autostart', dirPath: baseDir + 'apps/linux.html' },
