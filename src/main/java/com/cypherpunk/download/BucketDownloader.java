...
public class BucketDownloader extends HttpServlet
{
	...
	public static final String BUCKET_NAME = "download.cypherpunk.com"; 
	...
	/**
	 * Retrieves a file from GCS and returns it in the http resonse.
	...
	{
		String[] splits = req.getRequestURI().split("/", 2);
		LOG.log(Level.WARNING, "split 0", splits[0]);
		LOG.log(Level.WARNING, "split 1", splits[1]);
